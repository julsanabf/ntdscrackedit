...
{YELLOW}
 ...
 __    _  _______  ______   _______  _______  ______    _______  _______  ___   _  _______  ______   ___   _______ 
|  |  | ||       ||      | |       ||       ||    _ |  |   _   ||       ||   | | ||       ||      | |   | |       |
|   |_| ||_     _||  _    ||  _____||       ||   | ||  |  |_|  ||       ||   |_| ||    ___||  _    ||   | |_     _|
|       |  |   |  | | |   || |_____ |       ||   |_||_ |       ||       ||      _||   |___ | | |   ||   |   |   |  
|  _    |  |   |  | |_|   ||_____  ||      _||    __  ||       ||      _||     |_ |    ___|| |_|   ||   |   |   |  
| | |   |  |   |  |       | _____| ||     |_ |   |  | ||   _   ||     |_ |    _  ||   |___ |       ||   |   |   |  
|_|  |__|  |___|  |______| |_______||_______||___|  |_||__| |__||_______||___| |_||_______||______| |___|   |___|  

Herramienta para automatizar el proceso de NTLM hash cracking a partir de hashes obtenidos de un archivo NTDS.DIT
...
def guardarResultados(resultados, resultsfilepath):
    ...
    resultsfile.write("#####Generado por NTDSCrackeDIT#####\n\n")
...
def main():
    ...
    parser = argparse.ArgumentParser(description='NTDSCrackeDIT: Herramienta para automatizar el proceso de NTLM hash cracking a partir de hashes obtenidos de un archivo NTDS.DIT')
